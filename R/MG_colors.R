#' @title Predefined Color Palette for Consistent Plot Styling
#' @description A color vector containing a predefined set of colors
#' @return A character vector of hex color codes.
#'
#' @examples
#' \dontrun{
#' # Use MG_colors in ggplot2
#'   ggplot2::ggplot(mtcars, aes(x = wt, y = mpg, color = factor(cyl))) +
#'   geom_point(size = 3) +
#'   scale_color_manual(values = MG_colors[1:3]) +
#'   my_custom_theme()
#'}
#' @export
MG_colors <- c("#FFFF33", "#FF7F00", "#E41A1C", "firebrick4", "#2e4057", "#984EA3", "#377EB8",
