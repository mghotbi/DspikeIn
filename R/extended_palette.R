...
#'
#' This object and function provide an original color palette sequence (MG) and extend it by adding more colors using the rainbow function.
#' The extended palette can be used for plotting in ggplot2 or other plotting systems.
#'
#' @format A character vector of color codes.
#' @examples
