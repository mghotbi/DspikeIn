...
geometry: margin=1in
vignette: >
  %\VignetteIndexEntry{DspikeIn with Phyloseq}
...
#          Spiked species and related parameters for 16S (Phyloseq format)
...
#         Calculating Scaling Factors (Phyloseq object)
