...
```{r fig.align='center', fig.width=7, fig.height=5, out.width='50%', dpi=120, eval=requireNamespace("mia", quietly=TRUE)}
...
# Calculate the percentage of spike-in species retrieval per sample
  ...
  Spiked_16S_sum_scaled_filtered <-
    Spiked_16S_sum_scaled[
      ,
      colData(Spiked_16S_sum_scaled)$sample.or.blank != "blank"
    ]
...
# This section demonstrates alpha diversity analysis and distance-to-centroid calculations
# It requires the 'mia' package, which currently has compatibility issues with rbiom.
# Users can run this code manually in their own environment with compatible package versions.
...
# Alpha Diversity and Distance-to-Centroid Analysis
# ============================================================================
...
# 2. Calculate spike-in retrieval percentage
# ============================================================================
...
# 4. Add spike-in retrieval information
# ============================================================================

sample_metadata <- dplyr::left_join(
  sample_metadata,
  Perc,
  by = "Sample")
...
# Observed richness
observed <- vegan::specnumber(otu_mat)
...
# 6. Calculate Bray-Curtis distance to centroid
# ============================================================================

otu_mat_rel <- vegan::decostand(
  otu_mat,
  method = "total"
)
...
sample_metadata$Dist_to_Centroid <-
  dist_to_centroid[match(
    sample_metadata$Sample,
    names(dist_to_centroid)
  )]

# 7. Update TSE metadata
# ============================================================================

sample_metadata_df <- sample_metadata

rownames(sample_metadata_df) <-
  sample_metadata_df$Sample

sample_metadata_df$Sample <- NULL

sample_metadata_df <-
  sample_metadata_df[
    colnames(Spiked_16S_sum_scaled_filtered),
    ,
    drop = FALSE
  ]

colData(Spiked_16S_sum_scaled_filtered) <-
  S4Vectors::DataFrame(sample_metadata_df)
