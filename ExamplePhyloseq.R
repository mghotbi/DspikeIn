...
# Realign the taxonomy table with the OTU table if needed
physeq@tax_table <- phyloseq::tax_table(phyloseq::tax_table(physeq)[rownames(phyloseq::otu_table(physeq)), ])
